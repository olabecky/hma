(() => {
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function updateTable(data) {
            ...
            var rows = "<thead><tr><th scope=\"col\">#</th><th scope=\"col\">Firstname</th><th scope=\"col\">Lastname</th><th scope=\"col\">Email</th></tr></thead>"
            let sn = 1;
            data.forEach(element => {
                rows += `<tr><th scope=\"row\">${sn}</th><td>${element.firstname}</td><td>${element.lastname}</td><td>${element.email}</td></tr>`;
                sn++;
            });
